...
# NOTE:
# This is a simplified educational PrimeSwing implementation.
# It captures the recursive structure:
#
#     n! = odd_factorial(n) * 2^(n-popcount(n))
#
# where:
#
#     odd_factorial(n)
#       = odd_factorial(floor(n/2))^2 * odd_swing(n)
#
# Real high-performance PrimeSwing implementations are much
# more optimized than this reference version.
