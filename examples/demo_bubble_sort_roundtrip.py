#!/usr/bin/env python3
"""
Demo: Round-trip transpilation of bubble sort (Python → Lean → Python)
using the lp2 bidirectional transpiler.

Demonstrates nested while-loop transpilation end-to-end.
"""
...
def main():
    print("=== LP2: Python ↔ Lean Bubble Sort Demo ===\n")

    with open(os.path.join(os.path.dirname(__file__), "bubble_sort.py")) as f:
